...
# File:   pk_install_bluetoother-all.py
...
# In addition to the install_bluetoother.py parameters it sets the STMM_DEBIAN_PACKAGING
...
def main():
	...
	oParser = argparse.ArgumentParser(description="Install all bluetoother projects.\n"
						"  Same as install_bluetoother.py but sets STMM_DEBIAN_PACKAGING environment variable\n"
						"  to ON."
	...
	subprocess.check_call("./install_bluetoother.py {} {} {} {} {} {} {} {}".format(\
